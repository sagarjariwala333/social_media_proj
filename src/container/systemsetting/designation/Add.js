...
import { axiosDataSubmit, axiosFileUploder, axiosFileClear } from '../../../redux/sbo/observationtype/actionCreator';
...
const AddNew = () => {
  ...
  const { isLoading, url, isFileLoading } = useSelector(state => {
    return {
      isLoading: state.ObservationType.loading,
      url: state.ObservationType.url,
      isFileLoading: state.ObservationType.fileLoading,
    };
  });
      ...
      <PageHeader
        buttons={[
          <Button className="btn-add_new" size="default" key="1" type="primary">
            <Link to="/admin/sbo/observationtype">View All</Link>
          </Button>,
        ]}
        ghost
        title="Add New"
