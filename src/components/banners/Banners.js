...
const Banner2 = () => {
  return (
    <BannerWrapper>
      <Cards className="mb-70" bodyStyle={{ background: '#489343', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure2>
...
const Banner3 = () => {
  return (
    <BannerWrapper>
      <Cards  bodyStyle={{ borderRadius: '10px', minHeight: '270px', background: '#489343' }} headless>
        <Figure3>
