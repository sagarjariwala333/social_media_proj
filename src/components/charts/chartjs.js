...
const ChartjsGroupChart = props => {
  const { labels, dataA, dataB, dataC, options, height } = props;
  const values=[
    {
      data:dataA,
...
ChartjsGroupChart.defaultProps = {
  height: 200,
  labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
  dataA: [10, 40, 30, 40, 60, 55, 45, 35, 30, 20, 15, 20],
  dataB: [10, 40, 30, 40, 60, 55, 45, 35, 30, 20, 15, 20],
  dataC: [10, 40, 30, 40, 60, 55, 45, 35, 30, 20, 15, 20],
...
ChartjsPieChart.defaultProps = {
  height: 200,
  labels: ['Minor','NA','Major','Fatal'],
  datasets: [
    {
      data: [20, 20, 30, 25],
      backgroundColor: ['#560bd0', '#007bff', '#cbe0e3', '#74de00'],
    },
  ],
