...
import staticData from '../../demoData/dummy/directreferal.json'
...
const directreferalReducer = (state = initialState, action) => {
...
const directreferalSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {directreferalReducer, directreferalSingleReducer };
