...
import staticData from '../../demoData/dummy/capa.json';
...
const taskmanagementReducer = (state = initialStateFilter, action) => {
...
const taskmanagementSingleReducer = (state = initialState, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { taskmanagementSingleReducer, taskmanagementReducer };