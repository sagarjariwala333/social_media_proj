...
import staticData from '../../../demoData/dummy/category.json';
...
const categorySingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { categoryReducer, categorySingleReducer };
