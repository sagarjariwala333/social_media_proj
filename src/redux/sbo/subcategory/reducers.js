...
import staticData from '../../../demoData/dummy/subcategory.json';
...
const subcategorySingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { subcategoryReducer, subcategorySingleReducer };
