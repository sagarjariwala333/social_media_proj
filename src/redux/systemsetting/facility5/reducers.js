...
const initialState = {
  data: [
    { id: 1, name: 'Safety Professionals', head: 'John', facility4: 1, status: 'active' },
    { id: 2, name: 'GIC-12', head: 'Peter', facility4: 1, status: 'active' },
    { id: 3, name: 'GIC-13', head: 'Sujan', facility4: 1, status: 'active' },
    { id: 4, name: 'GIC 14', head: 'Jaimin', facility4: 2, status: 'active' },
  ],
  facilityLevel: [
    {
      Level1: 'Area',
...
const facility5Reducer = (state = initialState, action) => {
...
const facility5SingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { facility5Reducer, facility5SingleReducer };
