...
import staticData from '../../../demoData/dummy/position.json'
...
const positionSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {positionReducer, positionSingleReducer };
