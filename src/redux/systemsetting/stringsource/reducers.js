...
const initialState = {
  ...
  data: [
    ...
    {id:1, language:"English", resource:"English", value:"value",isEdit:false},
    {id:2, language:"English", resource:"English", value:"value",isEdit:false},
    {id:3, language:"English", resource:"English", value:"value",isEdit:false},
    {id:4, language:"English", resource:"English", value:"value",isEdit:false}
...
const stringsourceReducer = (state = initialState, action) => {
...
const stringsourceSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {stringsourceReducer, stringsourceSingleReducer };
