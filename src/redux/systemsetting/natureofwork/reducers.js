...
import staticData from '../../../demoData/dummy/natureofwork.json'
...
const natureofworkReducer = (state = initialState, action) => {
...
const natureofworkSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {natureofworkReducer, natureofworkSingleReducer };
