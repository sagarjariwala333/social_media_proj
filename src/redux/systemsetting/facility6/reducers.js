...
const initialState = {
  data: [
    { id: 1, name: 'Safety Professionals', head: 'John', facility5: 1, status: 'active' },
    { id: 2, name: 'GIC-12', head: 'Peter', facility5: 2, status: 'active' },
    { id: 3, name: 'GIC-13', head: 'Sujan', facility5: 2, status: 'active' },
    { id: 4, name: 'GIC 14', head: 'Jaimin', facility5: 2, status: 'active' },
  ],
  facilityLevel: [
    {
      Level1: 'Area',
...
const facility6Reducer = (state = initialState, action) => {
...
const facility6SingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { facility6Reducer, facility6SingleReducer };
