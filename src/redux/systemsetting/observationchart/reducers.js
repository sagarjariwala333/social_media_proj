...
const initialState = {
  ...
  data: [
    ...
    {id:1, label:'DIC CSPMILL', value: 40},
    {id:1, label:'DIC Iron', value: 50},
    {id:1, label:'DIC Utility', value: 60},
    {id:1, label:'DIC SMS2', value:30},
    {id:1, label:'DIC Cokeoven', value:20},
    {id:1, label:'DIC Logistics', value:45}
...
const obsChartReducer = (state = initialState, action) => {
...
const obsChartSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {obsChartReducer, obsChartSingleReducer };
