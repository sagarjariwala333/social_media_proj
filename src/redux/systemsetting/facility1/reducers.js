...
import staticData from '../../../demoData/dummy/facility1.json'
...
const facility1Reducer = (state = initialState, action) => {
...
const facility1SingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { facility1Reducer, facility1SingleReducer };
