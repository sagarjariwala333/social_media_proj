...
import staticData from '../../../demoData/dummy/designation.json';
...
const designationSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {designationReducer, designationSingleReducer };
