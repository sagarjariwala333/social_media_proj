...
import staticData from '../../../demoData/dummy/contractoragency.json'
...
const contractoragencyReducer = (state = initialState, action) => {
...
const contractoragencySingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {contractoragencyReducer, contractoragencySingleReducer };
