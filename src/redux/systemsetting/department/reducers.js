...
import staticData from '../../../demoData/dummy/department.json';
...
const departmentSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {departmentReducer, departmentSingleReducer };
