...
const initialState = {
  data: [
    { id: 1, name: 'Safety Professionals', head: 'John', facility3: 1, status: 'active' },
    { id: 2, name: 'GIC-12', head: 'Peter', facility3: 1, status: 'active' },
    { id: 3, name: 'GIC-13', head: 'Sujan', facility3: 2, status: 'active' },
    { id: 4, name: 'GIC 14', head: 'Jaimin', facility3: 2, status: 'active' },
  ],
  facilityLevel: [
    {
      Level1: 'Area',
...
const facility4Reducer = (state = initialState, action) => {
...
const facility4SingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { facility4Reducer, facility4SingleReducer };
