...
import staticData from '../../../demoData/dummy/contractoremployee.json'
...
const contractoremployeeReducer = (state = initialState, action) => {
...
const contractoremployeeSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {contractoremployeeReducer, contractoremployeeSingleReducer };
