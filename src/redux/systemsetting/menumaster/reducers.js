...
const initialState = {
  ...
  data: [
    ...
    {id:1, name:"name", icon:"icon", path:"path", parent:"parent"},
    {id:2, name:"name", icon:"icon", path:"path", parent:"parent"},
    {id:3, name:"name", icon:"icon", path:"path", parent:"parent"}
...
const menumasterSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {menumasterReducer, menumasterSingleReducer };
