...
const initialState = {
  data: [
    { id: 1, name: 'Safety Professionals', head: 'John', facility1: 1, status: 'active' },
    { id: 2, name: 'GIC-12', head: 'Peter', facility1: 1, status: 'active' },
    { id: 3, name: 'GIC-13', head: 'Sujan', facility1: 2, status: 'active' },
    { id: 4, name: 'GIC 14', head: 'Jaimin', facility1: 2, status: 'active' },
    { id: 5, name: 'GIC 15 new', head: 'New', facility1: 3, status: 'active' },
  ],
  facilityLevel: [
    {
      Level1: 'Area',
...
const facility2Reducer = (state = initialState, action) => {
...
const facility2SingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export { facility2Reducer, facility2SingleReducer };
