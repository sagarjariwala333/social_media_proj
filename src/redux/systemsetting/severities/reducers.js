...
import staticData from '../../../demoData/dummy/severities.json'
...
const severitiesReducer = (state = initialState, action) => {
...
const severitiesSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {severitiesReducer, severitiesSingleReducer };
