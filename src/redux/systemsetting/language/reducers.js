...
const initialState = {
  ...
  data: [
    ...
    {id:1, language:"English", languageculture:"England", languagecode:"EN", published:"true" },
    {id:2, language:"English", languageculture:"England", languagecode:"EN", published:"true" },
    {id:3, language:"English", languageculture:"England", languagecode:"EN", published:"true" }
...
const languageSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {languageReducer, languageSingleReducer };
