...
import staticData from "../../../demoData/dummy/employee.json"
...
const initialState = {
  ...
  data: staticData /* [
    {id:1, empcode:"E01", empname:"empname",  email:"email", address:"address", contactno:"contactno", dob:"dob", doj:"doj", position:"position", roles:"roles", l1reportee:"l1reportee", l2reportee:"l2reportee", sites:"sites", permissions:"permissions"},
    {id:1, empcode:"E01", empname:"empname",  email:"email", address:"address", contactno:"contactno", dob:"dob", doj:"doj", position:"position", roles:"roles", l1reportee:"l1reportee", l2reportee:"l2reportee", sites:"sites", permissions:"permissions"},
    {id:1, empcode:"E01", empname:"empname",  email:"email", address:"address", contactno:"contactno", dob:"dob", doj:"doj", position:"position", roles:"roles", l1reportee:"l1reportee", l2reportee:"l2reportee", sites:"sites", permissions:"permissions"},
    {id:1, empcode:"E01", empname:"empname",  email:"email", address:"address", contactno:"contactno", dob:"dob", doj:"doj", position:"position", roles:"roles", l1reportee:"l1reportee", l2reportee:"l2reportee", sites:"sites", permissions:"permissions"},
    {id:1, empcode:"E01", empname:"empname",  email:"email", address:"address", contactno:"contactno", dob:"dob", doj:"doj", position:"position", roles:"roles", l1reportee:"l1reportee", l2reportee:"l2reportee", sites:"sites", permissions:"permissions"},  
...
const employeeSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {employeeReducer, employeeSingleReducer };
