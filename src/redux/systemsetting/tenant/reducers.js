...
const initialState = {
  ...
  data: [
    ...
    {id:1, name:"Tenant", servertime:"10:00 AM", dbusername:"user", dbpassword:"user", portno: "8080", dbprefix: "dbpre"},
    {id:2, name:"Tenant", servertime:"10:00 AM", dbusername:"user", dbpassword:"user", portno: "8080", dbprefix: "dbpre"},
    {id:3, name:"Tenant", servertime:"10:00 AM", dbusername:"user", dbpassword:"user", portno: "8080", dbprefix: "dbpre"},
    {id:1, name:"Tenant", servertime:"10:00 AM", dbusername:"user", dbpassword:"user", portno: "8080", dbprefix: "dbpre"},
    {id:1, name:"Tenant", servertime:"10:00 AM", dbusername:"user", dbpassword:"user", portno: "8080", dbprefix: "dbpre"}
],
  url: null,
...
const tenantSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {tenantReducer, tenantSingleReducer };
