...
import staticData from '../../demoData/dummy/campaign.json'
...
const campaignSingleReducer = (state = initialStateSingle, action) => {
  const { type, data, err } = action;
  switch (type) {
...
export {campaignReducer, campaignSingleReducer };
